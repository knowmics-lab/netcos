...
cs_parameters$disease_signature_filename <- "data/colon_tumor/colon_tumor_150_most_significant_genes_b.Rds"
cs_parameters$drug_signatures_filename <- "output/drug_signature/LINCS/colon_tumor_150_most_significant_genes_metanalysis_6h_24h.Rds"
...
filename_no_ext <- "output/connectivity_score/colon_tumor_150_most_significant_genes_connectivity_score"
