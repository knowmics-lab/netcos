...
gene_symbols_filename <- "data/colon_tumor/colon_tumor_150_most_significant_genes_b.csv"
metanalysis_filename <- "output/drug_signature/LINCS/colon_tumor_150_most_significant_genes_metanalysis_6h_24h.Rds"
