...
gene_symbols <- c("DDR1", "PAX8", "FAU", "BCL2", "BIRC5", "CASP2", "CCL2", "CCNB1", "COASY", "CRTAP", "EGR1")

drugs_filter <- c("AM-251", "AM-404", "AM-580", "aminoglutethimide", "aminopurvalanol-a", "anandamide", "AQ-RA741", "angiogenesis-inhibitor", "austricine", "azacyclonol", "BAPTA-AM")
...
write.table(LINCS_drug_signatures_ma, paste0(LINCS_drug_signatures_ma_filename, "_2.csv"), sep = ";", row.names = F)
saveRDS(LINCS_drug_signatures_ma, paste0(LINCS_drug_signatures_ma_filename, "_2.Rds"))