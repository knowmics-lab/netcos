...
cs_parameters <- list()
cs_parameters$computation_title <- "ipf 150 most significant genes connectivity score computation"
cs_parameters$disease_name <- "ipf"
cs_parameters$disease_most_significant_genes_filename <- gsub(".csv", ".Rds", ipf_cfg$signature_150_most_significant_genes_filename)
...
cs_parameters$connectivity_score_filename <- ipf_cfg$connectivity_score_150_MS_genes_filename
