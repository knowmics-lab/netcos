...
cs_parameters$disease_most_significant_genes_filename <- gsub(".csv", ".Rds", als_2_signature_cfg$a150_most_significant_genes_filename)
...
filename_no_ext <- paste0(connectivity_score_cfg$cs_base_dir, als_2_signature_cfg$connectivity_score_150_MS_genes_filename)
