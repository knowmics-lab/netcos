...
cs_parameters <- list()
cs_parameters$computation_title <- "als NYGC 150 most significant genes connectivity score PharmacoGx computation"
...
cs_parameters$connectivity_score_filename <- als_NYGC_cfg$connectivity_score_PGx_150_MS_genes_filename
