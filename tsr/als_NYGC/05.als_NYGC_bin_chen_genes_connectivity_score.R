...
cs_parameters <- list()
cs_parameters$computation_title <- "als NYGC bin chen most significant genes connectivity score computation"
...
cs_parameters$connectivity_score_filename <- als_NYGC_cfg$connectivity_score_bin_chen_genes_filename
