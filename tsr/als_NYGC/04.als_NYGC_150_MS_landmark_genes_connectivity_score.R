...
cs_parameters <- list()
cs_parameters$computation_title <- "als NYGC 150 most significant landmark genes connectivity score computation"
cs_parameters$disease_name <- "als"
cs_parameters$disease_most_significant_genes_filename <- gsub(".csv", ".Rds", als_NYGC_cfg$signature_150_most_significant_landmark_genes_filename)
...
cs_parameters$connectivity_score_filename <- als_NYGC_cfg$connectivity_score_150_MS_landmark_genes_filename
