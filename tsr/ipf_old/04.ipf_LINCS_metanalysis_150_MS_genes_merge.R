...
gene_symbols_filename <- ipf_disease_signature_cfg$ipf_150_most_significant_genes_filename
metanalysis_filename <-  paste0(drug_signature_cfg$signature_base_dir, ipf_disease_signature_cfg$metanalysis_150_MS_base_filename, ".Rds")
