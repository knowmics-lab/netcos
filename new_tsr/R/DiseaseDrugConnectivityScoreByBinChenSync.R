...
DiseaseDrugConnectivityScoreByBinChenSync <- R6Class(
  "DiseaseDrugConnectivityScoreByBinChenSync",
  inherit = DiseaseDrugConnectivityScoreAbstract,
  public = list(
    initialize = function(drugSignatureLoader = NA) {
      private$connectivityScore <- DiseaseDrugConnectivityScoreByBinChen$new(RandomConnectivityScoreDistribution$new(), DrugListConnectivityScoreByBinChenSync$new(drugSignatureLoader))
    },
